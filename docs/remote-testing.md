...
measured against robotics-vm with nothing installed on it beforehand: create 5.6s, list 0.4s, attach 4.9s cold and 0.7s warm, an answer streamed 2.3s after asking.
